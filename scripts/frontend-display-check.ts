...
assert.match(styleSource, /\.terminal-body \{ flex:1; min-height:0; display:grid; grid-template-columns:408px minmax\(0, 0\.88fr\) 432px; overflow:hidden; \}/);
...
assert.match(styleSource, /\.risk-alerts \{ display:grid; gap:10px;/);
